  ...
  return (
    <div className="privacy">
      <div className="container">
        <h1>
          <strong>rebuzz Privacy Policy</strong>
        </h1>
        <h2>
          <strong>Effective: Dec 15th, 2019</strong>
        </h2>
        <p>
          This Privacy Policy describes how rebuzz collects, uses and discloses
          information, and what choices you have with respect to the
          information. This Policy applies to the&nbsp;rebuzz.io, rebuzz.io and
          rebuzz subdomains (e.g., signup.rebuzz.io) and
          services&nbsp;(collectively, “Services”).
        </p>
        <p>
          Updates in this version of the Privacy Policy reflect changes in data
          protection law.
        </p>
        <p>
          When we refer to “rebuzz”, we mean the rebuzz entity that acts as the
        ...
        <p>
          ...
          user’s Internet Protocol (IP) address, device and browser type, and
          operating system. We use this information to administer and provide
          access to the Services
        </p>
        <p>
          Information we will never collect. We will never ask you to share your
          password. Never trust anyone or any site that asks you to enter your
          password.
        </p>
        <p>
        ...
        <p>
          ...
          Service on our behalf (such as customer support, hosting, email
        ...
        <p>
          ...
          problems, assist with any investigation, enforce our Terms of Service,
        ...
        <p>
          ...
          maintaining the security of any password, user ID or other form of
          authentication involved in obtaining access to password protected or
          secure areas of any of our digital services.
        </p>
        <p>
        ...
        <p>
          ...
          sending a request to privacy@rebuzz.io. You can request to change
          contact choices, opt-out of our sharing with others, and update your
          personal information and preferences. We may require that you are the
          you are the user who you say you are by proving that you have control
          of&nbsp; your account.
        </p>
        <p>
        ...
        <p>
          ...
          contact us at: privacy@rebuzz.io.
        </p>
        <p>
        ...
        <p>
          ...
          personal information, contact us at legal@rebuzz.io.
        </p>
        <p>
        ...
        <p>
          ...
          the Service or by contacting us at privacy@rebuzz.io
        </p>
        <p>
        ...
        <p>
          You can submit these requests by email to privacy@rebuzz.io. We may
          ...
          at privacy@rebuzz.io or submit a complaint to the data protection
          regulator in your jurisdiction. You can find your data protection
          regulator&nbsp;
          <a href="https://www.google.com/url?q=http://ec.europa.eu/justice/article-29/structure/data-protection-authorities/index_en.htm&amp;sa=D&amp;ust=1527292847107000">
            here
          </a>
          .
        </p>
        ...
        <ul>
          ...
          <li>
            To track site usage so we can improve our site &amp; better
        ...
        <p>
          Click&nbsp;
          <a href="https://www.google.com/url?q=https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences&amp;sa=D&amp;ust=1527292847109000">
            here
          </a>
        ...
        <p>
          Click&nbsp;
          <a href="https://www.google.com/url?q=https://support.google.com/chrome/answer/95647?hl%3Den&amp;sa=D&amp;ust=1527292847109000">
            here
          </a>
        ...
        <p>
          Click&nbsp;
          <a href="https://www.google.com/url?q=https://support.microsoft.com/en-us/help/17442/windows-internet-explorer-delete-manage-cookies&amp;sa=D&amp;ust=1527292847110000">
            here
          </a>
        ...
        <p>
          Click&nbsp;
          <a href="https://www.google.com/url?q=https://support.apple.com/kb/ph21411?locale%3Den_US&amp;sa=D&amp;ust=1527292847110000">
            here
          </a>
        ...
        <p>
          ...
          delete them, please visit http://www.aboutcookies.org for detailed
          guidance. In addition, certain third party advertising networks,

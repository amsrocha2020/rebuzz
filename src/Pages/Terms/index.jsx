  ...
  return (
    <div className="terms">
      <div className="container">
        ...
        <h2>
          <strong>Last Updated: Dec 15th, 2019</strong>
        </h2>
        <p>
          Welcome to rebuzz! This agreement (the “Agreement”) between you and
          Fizz Media Corporation (“we”, “us”, “our”) sets out your rights to
          access and use of rebuzz.io and any other products or services
          provided by us (the “Service”). If you are accepting this Agreement
          ...
          this Agreement. By accessing our Service, you agree that you have
        ...
        <p>
          ...
          notice on rebuzz.io. Your continued use of the Service will confirm
        ...
        <p>
          ...
          under the age of 18. You must be at least 18 years of age to access or
          use of the Service. If you are 18 years of age (or the age of legal
          majority where you reside), you may only access or use the Service
        ...
        <p>
          ...
          supplied by us, the rebuzz blockchain or our licensors, which we call
          “rebuzz Content.” rebuzz Content is protected by intellectual property
          laws, including copyright and other proprietary rights of the United
          States and foreign countries. Except as explicitly stated in this
          Agreement, we do not grant any express or implied rights to use rebuzz
          Content.
        </p>
        <p>
          You are granted a limited, non-exclusive, non-transferable, and
          non-sublicensable license to access and use the Service and rebuzz
        ...
        <p>
          “rebuzz,”, the rebuzz logo and any other product or service names,
          logos, slogans that may appear on the Service are trademarks of Fizz
          Media Corporation, and, may not be copied, imitated, or used, in whole
          or in part, unless explicitly permitted or without first receiving
          written permission from us to do so. The look and feel of
          rebuzzReviewers.com and the Service is protected by copyright © Fizz
          Media Corporation All rights reserved. You may not duplicate, copy, or
          reuse any portion of the HTML/CSS, Javascript, or visual design
          elements or concepts without express written permission.
        </p>
        <p>
          We encourage third-party dapp developers building on top of the rebuzz
          blockchain to reach out to legal@rebuzz.io for all branding and
          licensing questions.
        </p>
        <p>
        ...
        <ol>
          <li>
            <strong>Assumption of Risk, Limitations on Liability.</strong>
          </li>
        </ol>
        <p>
          5.1. You accept and acknowledge that there are risks associated with
          utilizing an Internet-based rebuzz blockchain account service
          ...
          access to information stored within or associated with your Account,
          including, but not limited to your private key(s) (“Private Key”). You
        ...
        <p>
          ...
          arising from: (a) User error such as forgotten passwords, lost private
          keys, forgotten pin codes, incorrectly constructed transactions, or
          mistyped rebuzz blockchain addresses; (b) Server failure or data loss;
          (c) Corrupted Account files; (d) Unauthorized access to applications;
          ...
          of attack against the Service or Services.
        </p>
        <p>
        ...
        <p>
          5.5. Subject to 6.1 below, any and all indemnities, warranties, terms,
          and conditions (whether express or implied) are hereby excluded to the
          fullest extent permitted under Arizona law.
        </p>
        <p>
        ...
        <p>
          5.7. Nothing in this Agreement excludes or limits liability for death
        ...
        <ol>
          <li>
            <strong>Agreement to Hold Fizz Media Corporation Harmless</strong>
          </li>
        </ol>
        <p>
          6.1. You agree to hold harmless Fizz Media Corporation (and each of
          our officers, directors, members, employees, agents, and affiliates)
          from any claim, demand, action, damage, loss, cost, or expense,
          including without limitation reasonable legal fees, arising out, or
          relating to:
        </p>
        ...
        <p>
          6.2. If you are obligated to indemnify us, we will have the right, in
          our sole discretion, to control any action or proceeding (at our
          expense) and determine whether we will pursue a settlement of any
          action or proceeding.
        </p>
        <ol>
          <li>
            <strong>No Liability for Third-Party Services and Content</strong>
          </li>
        </ol>
        <p>
          7.1. In using our Services, you may view content or utilize services
        ...
        <p>
          8.1. You need not use a rebuzz blockchain account provided by us, and
          you can create an account independently of the Service. If you would
          like to use part of the Service, you must create a rebuzz blockchain
          ...
          of your Account by protecting your Account password or private key and
          access to your computer and your Account; (e) Promptly notify us if
          you discover or otherwise suspect any security breaches related to
          your Account.
        </p>
        <p>
          8.2. You hereby accept and acknowledge that you take responsibility
        ...
        <p>
          8.3. You acknowledge and understand that cryptography is a progressing
          ...
          of your property. By using the Service or accessing rebuzz Content,
        ...
        <p>
          ...
          things, provide software that facilitates the submission of rebuzz
          blockchain transaction data to the rebuzz blockchain without requiring
          you to access the rebuzz blockchain command line interface.
        </p>
        <p>
          9.2. Account and Private Keys. Should you agree to create an Account
          through our Service, we generate a cryptographic private and public
          key pair that are provided solely to you and completely owned by you;
          provided however that we not store passwords or Private Keys for you.
          We never have access to your Private Key and do not custody any
          Private Keys on your behalf, and therefore, assume no responsibility
          for the management of the Private Key tied to your Account. The
          Private Key uniquely match the Account name and must be used in
          connection with the Account to authorize the transfer of BUZZ from
          that Account. You are solely responsible for maintaining the security
          of your Private Keys. You must keep your Private Key access
          information secure. Failure to do so may result in the loss of control
          of BUZZ Account.
        </p>
        <p>
          9.3. No Password Retrieval. We do not receive or store your Account
          ...
          your Account, you accept and acknowledge that any BUZZ information
          have associated with such Account will become permanently inaccessible
          if you do not have your Account password.
        </p>
        <p>
          9.4. Transactions. All proposed rebuzz blockchain transactions must be
          confirmed and recorded in the rebuzz blockchain via the rebuzz
          distributed consensus network (a peer-to-peer network), which is not
          owned, controlled, or operated by us. The rebuzz blockchain is
          operated by a decentralized network of independent third parties. We
          have no control over the rebuzz blockchain and therefore cannot and
          will not ensure that any transaction details you submit via the
          Services will be confirmed on the rebuzz blockchain. You acknowledge
          and agree that the transaction details you submit via the Services may
          not be completed, or may be substantially delayed, by the rebuzz
          blockchain. You may use the Services to submit these details to the
          rebuzz blockchain.
        </p>
        <p>
          9.5. No Storage or Transmission of any blocks on the blockchain in any
          of its forms.
        </p>
        <p>
          9.6. Relationship. Nothing in this Agreement is intended to nor shall
        ...
        <p>
          ...
          omissions that you make in connection with any rebuzz blockchain
        ...
        <p>
          9.8. No Cancellations or Modifications. Once transaction details have
          been submitted to the rebuzz blockchain via the Services, The Services
          cannot assist you to cancel or otherwise modify your transaction
          details. We have no control over the rebuzz blockchain and do not have
          the ability to facilitate any cancellation or modification requests.
        </p>
        <p>
          9.9. Taxes. It is your responsibility to determine what, if any, taxes
          ...
          rebuzz blockchain transactions or for collecting, reporting,
          withholding, or remitting any taxes arising from any rebuzz blockchain
          transactions.
        </p>
        <ol>
          <li>
            <strong>Fees for Using the Services</strong>
          </li>
        </ol>
        <p>
          10.1. Fees Creating an Account. We do not currently charge fees for
          any Services in connection with the creation of Accounts, however we
          reserve the right to do so in future, and in such case any applicable
        ...
        <ol>
          <li>
            <strong>
              No Right to Cancel And/or Reverse rebuzz Blockchain Transactions
            </strong>
          </li>
        </ol>
        <p>
          11.1. If you use BUZZ and commit a post, you will not be able to
          change your mind once you have confirmed that you wish to proceed as
          it is stored on immutable blockchain.
        </p>
        <ol>
          <li>
        ...
        <p>
          12.1. We may, in our sole discretion and without cost to you, with or
        ...
        <p>
          12.2. If you do not maintain a backup of your Account data outside of
          the Services, you will be may not be able to access BUZZ data
          associated with any Account maintained in your Account if we
          discontinue or deprecate the Services.
        </p>
        <ol>
          <li>
            <strong>Suspension or Termination of Service.</strong>
          </li>
        </ol>
        <p>
          13.1. We may suspend or terminate your access to the Services in our
          sole discretion, immediately and without prior notice, and delete or
          deactivate your rebuzz.io account and all related information and
          files in such without cost to you, including, for instance, if you
          breach any term of this Agreement. In the event of termination, your
          access to the BUZZ in your account will require you access to the
          rebuzz blockchain via the command line API or third party tool, and
          will require you to have access to your backup of your Account data
        ...
        <p>
          14.1. When accessing or using the Services, you agree that you will
        ...
        <p>
          14.1.1. Use of our Services in any manner that could interfere with,
        ...
        <p>
          14.1.2. Use our Services to pay for, support or otherwise engage in
        ...
        <p>
          14.1.6. Encourage or induce any third-party to engage in any of the
          activities prohibited under this Section.
        </p>
        <ol>
          <li>
            <strong>Copyright Complaints, the DMCA, and Takedowns</strong>
          </li>
        </ol>
        <p>
          ...
          submit a properly formatted DMCA request (see 17 U.S.C. § 512) to Fizz
          Media Corporation
        </p>
        <p>
        ...
        <p>Copyright Agent</p>
        <p>Fizz Media Corporation</p>
        <p>7373 E. Doubletree Ranch Rd. Ste B200</p>
        <p>Scottsdale, Arizona 85258</p>
        <p>copyright@rebuzz.io</p>
        ...
        <ol>
          <li>The URL or Internet location of the materials claimed to be infringing or to be the subject of infringing activity, or information
          reasonably sufficient to permit us to locate the material;</li>
        </ol>
        <ol>
          <li>Your name, address, telephone number, and email address;</li>
          <li>A statement by you that you have a good faith belief that the disputed use of the material is not authorized by the copyright owner,its agent, or the law; and A statement by you, made under penalty of perjury, that the above</li>
        </ol>
        <p>
        ...
        <p>
          ...
          content was wrongly removed due to a mistake or misidentification of
          the material, you can s end a counter-notice to our Copyright Agent
          (contact information provided above) that includes the following:
        </p>
        <ol>
        ...
        <p>
          ...
          rebuzz Content are provided on an “as is” and “as available” basis,
          without warranties of any kind, either express or implied, including,
          without limitation, implied warranties of merchantability, fitness for
          a particular purpose, title and non-infringement and any warranties
          implied by any course of performance or usage of trade. The company
          does not represent or warrant that the Service and the rebuzz Content:
          (a) will be secure or available at any time or location; (b) are
          accurate, complete, reliable, current, or error-free or that any
          defects or errors will be corrected; and (c) are free of viruses or
          other harmful components. Your use of the Service and rebuzz Content
          is solely at your own risk. Some jurisdictions do not allow the
          disclaimer of implied terms in contracts with consumers, so some or
        ...
        <p>
          ...
          Fizz Media Corporation or the any related party to Fizz Media
          Corporation, that includes but is not limited to, subsidiaries,
          vendors, or contractors, be liable for any special, indirect,
          ...
          Service or the rebuzz Content. To the fullest extent permitted by
          applicable law, in no event shall the aggregate liability of Fizz
          Media Corporation or any related party, whether in contract, warranty,
        ...
        <p>
          ...
          arbitrate certain disputes with Fizz Media Corporation and limits the
          way you can seek relief from Fizz Media Corporation If you do not
          agree with this Section 20, please discontinue using the Service.
        </p>
        <p>
          20.1. Binding Arbitration. Except for disputes in which either party
          ...
          you and Fizz Media Corporation: (a) waive your right to have any and
          all disputes or Claims arising from this Agreement or Fizz Media
          Corporation (collectively, “Disputes”) resolved in a court; and (b)
          waive your right to a jury trial. Instead, you and Fizz Media
          Corporation will arbitrate Disputes through binding arbitration (which
        ...
        <p>
          ...
          You agree that any dispute is personal to you and Fizz Media
          Corporation and that any such dispute will be resolved solely through
          ...
          of another individual or group of individuals. Further, you and Fizz
          Media Corporation agree that a dispute cannot be brought as a class,
        ...
        <p>
          20.3. Federal Arbitration Act. You agree that this Agreement affects
        ...
        <p>
          20.4. Process. You agree that you will notify us in writing of any
          ...
          legal@rebuzzReviewers.com. Your notice must include: (1) your name,
          postal address, and email address; (2) a description of the nature or
          basis of the Dispute; and (3) the specific relief that you are
          seeking. If we cannot agree how to resolve the Dispute within thirty
          (30) days of the us receiving the notice, either you or Fizz Media
          Corporation may, as appropriate pursuant to this Section 20, commence
          an arbitration proceeding or file a claim in court. You agree that any
          arbitration or claim against us must be commenced or filed within one
          (1) year after the Dispute arose; otherwise, you agree that the claim
          is permanently barred (which means that you will no longer have the
          right to assert a claim regarding the Dispute). You have read,
          understand, and agree that: (a) any arbitration will occur in Maricopa
          County, Arizona; (b) arbitration will be conducted confidentially by a
          single arbitrator in accordance with the rules of JAMS; and (c) the
          state or federal courts in Arizona will have exclusive jurisdiction
        ...
        <p>
          20.5. Authority of Arbitrator. As limited by the FAA, this Agreement
        ...
        <p>
          20.6. Rules of JAMS. The rules of, and additional information about,
        ...
        <p>
          20.7. Severability. If any term, clause, or provision of this Section
        ...
        <p>
          ...
          rebuzz Content will be governed by, and construed in accordance with,
          the laws of Arizona, without resort to its conflict of law provisions.
          To the extent the arbitration provision in Section 20 does not apply
          and the Dispute cannot be heard in small claims court, you agree that
          ...
          in Maricopa County, Arizona and you hereby irrevocably and
        ...
        <p>
          ...
          includes, rebuzzReviewers.com, and to block or prevent your future
          access to, and use of, the Service that we provide.
        </p>
        <ol>
          <li>
        ...
        <p>
          ...
          on rebuzzReviewers.com. By continuing to use the Services after a
        ...
        <p>
          Notices to Fizz Media Corporation should be directed to
          legal@rebuzzReviewers.com.
        </p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
